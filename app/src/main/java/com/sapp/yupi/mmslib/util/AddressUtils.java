 ...
 */
package com.sapp.yupi.mmslib.util;
...
import com.sapp.yupi.mmslib.pdu.PduHeaders;
import com.sapp.yupi.mmslib.pdu.PduPersister;
...
public class AddressUtils {
    ...
    public static String getFrom(ContentResolver contentResolver, String msgId) {
        ...
        Cursor cursor = contentResolver.query(builder.build(),
                new String[]{Addr.ADDRESS, Addr.CHARSET},
